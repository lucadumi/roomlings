...
def install(repository):
    ...
    brand = repository / "public/brand"
    brand.mkdir(parents=True, exist_ok=True)
    shutil.copyfile(ROOT / "exports/roomlings-icon-flat-256.png", brand / "roomlings-icon-flat-256.png")
    ...
    print("Installed the 2D app icon, wordmark, intrinsic dimensions, favicon and email mark.")
