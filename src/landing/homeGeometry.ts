...
function plant(x: number, z: number, size = 1): IllustrationFace[] {
  ...
  return [
    ...box({ x, z, w: size * 0.44, d: size * 0.44, h: size * 0.5, top: '#765942', front: '#bc7e55', side: '#a16b49' }),
    ...[[-0.5, 1.2, 0.1], [0.4, 1.4, -0.2], [0.12, 1.75, 0.1], [-0.15, 1.25, 0.65], [0.6, 1.05, 0.35]].map(([dx, dy, dz], index) =>
      face(['#6c865c', '#91a274', '#5b7750', '#7d935f', '#a1af82'][index], [
...
export const homeGround: IllustrationFace[] = [
  ...
  ...Array.from({ length: 7 }, (_, x) => Array.from({ length: 9 }, (_, z) => face((x + z) % 2 ? '#d5ddc6' : '#e8ebdc', [
  ...
  face('#dbe2d5', [[4.6, 0.03, 0], [8, 0.03, 0], [8, 0.03, 2.5], [4.6, 0.03, 2.5]]),
  face('#ece7d2', [[4.72, 0.04, 3.04], [7.83, 0.04, 3.04], [7.83, 0.04, 5.68], [4.72, 0.04, 5.68]]),
...
export const homeSurfaces: IllustrationFace[] = [
  ...
  face('#b7cebf', [[0.19, 1.5, 3.2], [0.19, 2.66, 3.2], [0.19, 2.66, 5.17], [0.19, 1.5, 5.17]]),
  face('#d9e2cc', [[0.2, 1.5, 3.2], [0.2, 1.9, 3.2], [0.2, 2.15, 4.4], [0.2, 1.65, 5.17], [0.2, 1.5, 5.17]]),
  ...
  ...[0.84, 1.87, 2.9].flatMap((x) => [
    face('#98ac8d', [[x, 0.14, 1.2], [x + 0.9, 0.14, 1.2], [x + 0.9, 0.91, 1.2], [x, 0.91, 1.2]]),
  ...
  face('#9fbbae', [[5.45, 0.795, 0.7], [7.36, 0.795, 0.7], [7.36, 0.795, 1.5], [5.45, 0.795, 1.5]]),
  face('#c8ddd0', [[5.56, 0.8, 0.82], [7.25, 0.8, 0.82], [7.25, 0.8, 1.38], [5.56, 0.8, 1.38]]),
  ...
  face('#cb8065', [[4.77, 1.07, 0.69], [4.77, 1.72, 0.69], [4.77, 1.72, 1.26], [4.77, 1.02, 1.26]]),
  ...
  ...[3.28, 4.29].flatMap((z) => box({ x: 6.68, y: 0.53, z, w: 0.76, h: 0.19, d: 0.94, top: '#b1bf94', front: '#9cac81', side: '#809466' })),
  ...[3.09, 5.28].flatMap((z) => box({ x: 6.59, y: 0.53, z, w: 1.18, h: 0.48, d: 0.2, top: '#a5b58a', front: '#8c9f75', side: '#7b9063' })),
  ...
  face('#c77854', [[2.21, 1.32, 3.44], [2.57, 1.32, 3.44], [2.57, 1.32, 3.49], [2.21, 1.32, 3.49]]),
