export function TourFallback() {
  return <svg className="welcome-illustration" viewBox="0 0 1000 820" fill="none" aria-hidden="true">
    ...
    <path d="M98 470V201L552 44v210z" fill="#eaddc1" />
    <path d="m552 44 361 205v220L552 254z" fill="#f2e7d0" />
    <path d="m98 470 454-216 361 215-437 223z" fill="#dce3ce" />
    <g stroke="#bfcbb4" strokeWidth="2" opacity=".65">
    ...
    <path d="m637 173 115 64v83l-115-64z" fill="#b6d0c8" />
    <path d="m695 205 0 84m-57-79 115 64" stroke="#fff4da" strokeWidth="6" />
    <path d="m548 353 227 126 92-47-225-126z" fill="#fff0d5" />
    <path d="m548 353 227 126v111L548 466z" fill="#88a08d" />
    <path d="m775 479 92-47v113l-92 45z" fill="#6f8b79" />
    <g stroke="#bdceae" strokeWidth="3"><path d="M604 387v98m57-66v97m57-65v97" /></g>
    <g stroke="#f5e8cd" strokeWidth="5"><path d="m565 383 19 10m40 23 19 10m40 21 19 10m39 20 19 10" /></g>
    <path d="m197 253 126-50 122 64-129 56z" fill="#bdcbaa" />
    <path d="m197 253 119 70v250l-119-72z" fill="#8ea78c" />
    <path d="m316 323 129-56v253l-129 53z" fill="#a5ba99" />
    <path d="m322 409 117-50" stroke="#6e856a" strokeWidth="3" />
    <path d="m423 385 0 31m0 32v61" stroke="#f5efdc" strokeWidth="7" strokeLinecap="round" />
    <path d="m342 346 34-14v32l-34 14z" fill="#f8edcd" />
    <circle cx="358" cy="340" r="5" fill="#bf5b40" />
    ...
    <path d="m451 474 12-25 22 6-4 24z" fill="#7f965a" />
    <path d="m559 538 47-24 50 28-47 26z" fill="#c55a3e" />
    ...
    <path d="m666 387 17 9v26q-10 11-24 0v-23z" fill="#c45c3d" />
    <path d="M665 391q-3-28 16-12l9 10" stroke="#b18a60" strokeWidth="5" />
    <path d="m846 380 23 10-6 41-23-4z" fill="#be8462" />
    <path d="m851 389-15-46 21 8 7 30m-2-6 15-48 9 27-22 31" fill="#819560" />
    <path d="m219 537 30 16-6 42-24-7z" fill="#c28a64" />
    <path d="m232 548-30-65 26 12 8 36m0 7 27-56 9 35-32 26m-2-22-7-54 22 20-12 37" fill="#7e965d" />
    <path d="m546 51 0 184" stroke="#c1a882" strokeWidth="3" />
    <path d="m515 230 24-30 21 5 33 48-52 11z" fill="#c78763" />
  </svg>
}
